...
<!-- Rancher diagram](../img/rancher/ranchercomponentsdiagram.svg)<br/>
...
>**Note:** For large amounts of data, please use [GitHub Gist](https://gist.github.com.md) or similar and link the created resource in the issue.
