...
> This page is about secrets in general. For details on setting up a private registry, refer to the section on [registries.](./k8s-in-rancher/registries)
...
For more information on adding secret to a workload, see [Deploying Workloads](./k8s-in-rancher/workloads/deploy-workloads.md).
