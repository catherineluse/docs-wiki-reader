...
This section assumes that you understand how persistent storage works in Kubernetes. For more information, refer to the section on [how storage works.](./cluster-admin/volumes-and-storage/how-storage-works.md)

>**Prerequisites (for both parts A and B):**
>
>[Persistent volumes](./cluster-admin/volumes-and-storage.md) must be available for the cluster.
