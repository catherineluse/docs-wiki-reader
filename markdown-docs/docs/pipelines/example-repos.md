...
> **Note:** The example repositories are only available if you have not [configured a version control provider](./project-admin/pipelines).
...
For detailed information about setting up your own pipeline for your repository, [configure a version control provider](./project-admin/pipelines), enable a repository and finally configure your pipeline.
