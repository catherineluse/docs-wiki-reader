...
>**Tip:** Want to provide a user with access to _all_ projects within a cluster? See [Adding Cluster Members](./cluster-provisioning/cluster-members.md) instead.

### Adding Members to a New Project

You can add members to a project as you create it (recommended if possible). For details on creating a new project, refer to the [cluster administration section.](./k8s-in-rancher/projects-and-namespaces.md)
...
1. Assign the user or group **Project** roles.  
	...
	[What are Project Roles?](./admin-settings/rbac/cluster-project-roles.md)
    ...
    >
    >    - To add roles to the list, [Add a Custom Role](./admin-settings/rbac/default-custom-roles).
    >    - To remove roles from the list, [Lock/Unlock Roles](./admin-settings/rbac/locked-roles.md).
