...
System Tools is a tool to perform operational tasks on [Rancher Launched Kubernetes](./cluster-provisioning/rke-clusters.md) clusters or [installations of Rancher on an RKE cluster.](./installation/install-rancher-on-k8s.md) The tasks include:
...
The logs subcommand will collect log files of core Kubernetes cluster components from nodes in [Rancher-launched Kubernetes clusters](./cluster-provisioning/rke-clusters.md) or nodes on an [RKE Kubernetes cluster that Rancher is installed on.](./installation/install-rancher-on-k8s.md). See [Troubleshooting](.//rancher/v2.0-v2.4/en/troubleshooting.md) for a list of core Kubernetes cluster components.
...
The stats subcommand will display system metrics from nodes in [Rancher-launched Kubernetes clusters](./cluster-provisioning/rke-clusters.md) or nodes in an [RKE Kubernetes cluster that Rancher is installed on.](./installation/install-rancher-on-k8s.md).
