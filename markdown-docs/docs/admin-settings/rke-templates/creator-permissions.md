...
For more information on administrator permissions, refer to the [documentation on global permissions](./admin-settings/rbac/global-permissions.md).
...
For information on allowing users to modify existing templates, refer to [Sharing Templates.](./admin-settings/rke-templates/template-access-and-sharing)
