...
To complete the tasks on this page, one of the following permissions are required:
 ...
 - [Custom Global Permissions](./admin-settings/rbac/global-permissions/#custom-global-permissions) with the [Manage Roles](./admin-settings/rbac/global-permissions.md) role assigned.
...
1.  Use the **Grant Resources** options to assign individual [Kubernetes API endpoints](https://kubernetes.io/docs/reference.md) to the role.
...
1.  Choose whether to set the role to a status of [locked](./admin-settings/rbac/locked-roles.md).
...
>
> * You have set up an [external authentication provider](./admin-settings/authentication/#external-vs-local-authentication)
> * The external authentication provider supports [user groups](./admin-settings/authentication/user-groups.md)
