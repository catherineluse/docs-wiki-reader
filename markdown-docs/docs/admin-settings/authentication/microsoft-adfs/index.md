...
- [1. Configuring Microsoft AD FS for Rancher](./admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup)
- [2. Configuring Rancher for Microsoft AD FS](./admin-settings/authentication/microsoft-adfs/rancher-adfs-setup)

{{< saml_caveats >}}


### [Next: Configuring Microsoft AD FS for Rancher](./admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup)
