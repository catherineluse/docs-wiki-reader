...
After you complete [Configuring Microsoft AD FS for Rancher](./admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup.md), enter your AD FS information into Rancher to allow AD FS users to authenticate with Rancher.
