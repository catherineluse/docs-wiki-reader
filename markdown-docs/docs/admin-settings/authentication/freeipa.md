...
>**Prerequisites:**
>
>- You must have a [FreeIPA Server](https://www.freeipa.org.md) configured.
...
>- Read [External Authentication Configuration and Principal Users](./admin-settings/authentication/#external-authentication-configuration-and-principal-users).
