...
>**Prerequisites:** Read [External Authentication Configuration and Principal Users](./admin-settings/authentication/#external-authentication-configuration-and-principal-users).
