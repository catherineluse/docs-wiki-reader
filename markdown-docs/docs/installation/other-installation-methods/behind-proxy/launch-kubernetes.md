...
*  [RKE CLI binary](./rke/latest/en/installation/#download-the-rke-binary)
...
* [kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl.md)
...
* [helm](https://helm.sh/docs/intro/install.md)
...
Next, create a YAML file that describes the RKE cluster. Ensure that the IP addresses of the nodes and the SSH username are correct. For more information on the cluster YAML, have a look at the [RKE documentation](./rke/latest/en/example-yamls.md).
