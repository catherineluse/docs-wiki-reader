...
The infrastructure depends on whether you are installing Rancher on a K3s Kubernetes cluster, an RKE Kubernetes cluster, or a single Docker container. For more information on each installation option, refer to [this page.](./installation.md)
...
Make sure that your nodes fulfill the general installation requirements for [OS, container runtime, hardware, and networking.](./installation/requirements.md)
...
* [PostgreSQL](https://www.postgresql.org.md) (certified against versions 10.7 and 11.5)
* [MySQL](https://www.mysql.com.md) (certified against version 5.7)
* [etcd](https://etcd.io.md) (certified against version 3.3.15)
...
For the complete list of options that are available for configuring a K3s cluster datastore, refer to the [K3s documentation.](./k3s/latest/en/installation/datastore.md)
...
In a later step, when you set up your K3s Kubernetes cluster, you will create a [private registries configuration file](./k3s/latest/en/installation/private-registry.md) with details from this registry.
...
Make sure that your node fulfills the general installation requirements for [OS, Docker, hardware, and networking.](./installation/requirements.md)
...
If you need help with creating a private registry, please refer to the [official Docker documentation.](https://docs.docker.com/registry.md)

{{% /tab %}}
{{% /tabs %}}

### [Next: Collect and Publish Images to your Private Registry](./installation/other-installation-methods/air-gap/populate-private-registry.md)
