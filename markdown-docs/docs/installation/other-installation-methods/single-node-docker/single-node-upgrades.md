...
- **Review the [known upgrade issues](./installation/install-rancher-on-k8s/upgrades/#known-upgrade-issues) in the Rancher documentation for the most noteworthy issues to consider when upgrading Rancher. A more complete list of known issues for each Rancher version can be found in the release notes on [GitHub](https://github.com/rancher/rancher/releases) and on the [Rancher forums.](https://forums.rancher.com/c/announcements/12) Note that upgrades to or from any chart in the [rancher-alpha repository](./installation/install-rancher-on-k8s/chart-options/#helm-chart-repositories.md) aren’t supported.
...
------------|-------------
`<RANCHER_VERSION_TAG>` | The release tag of the [Rancher version](./installation/resources/chart-options.md) that you want to upgrade to.
...
If you used a proxy, see [HTTP Proxy Configuration.](./installation/other-installation-methods/single-node-docker/proxy.md)

If you configured a custom CA root certificate to access your services, see [Custom CA root certificate.](./installation/other-installation-methods/single-node-docker/advanced/#custom-ca-certificate)

If you are recording all transactions with the Rancher API, see [API Auditing](./installation/other-installation-methods/single-node-docker/advanced/#api-audit-log)
...
>**Remember:** Let's Encrypt provides rate limits for requesting new certificates. Therefore, limit how often you create or destroy the container. For more information, see [Let's Encrypt documentation on rate limits](https://letsencrypt.org/docs/rate-limits.md).

If you have selected to use [Let's Encrypt](https://letsencrypt.org.md) certificates, you add the `--volumes-from rancher-data` to the command that you had started your original Rancher server container and need to provide the domain that you had used when you originally installed Rancher.
...
`<RANCHER_VERSION_TAG>` | The release tag of the [Rancher version](./installation/resources/chart-options.md) that you want to to upgrade to.
...
If your upgrade does not complete successfully, you can roll back Rancher server and its data back to its last healthy state. For more information, see [Docker Rollback](./upgrades/rollbacks/single-node-rollbacks.md).
