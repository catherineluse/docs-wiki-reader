...
* [Amazon ELB configuration](./installation/resources/k8s-tutorials/infrastructure-tutorials/nlb.md)
* [NGINX configuration](./installation/resources/k8s-tutorials/infrastructure-tutorials/nginx.md)
...
- **Recommended:** Review [Creating Backups—High Availability Back Up and Restoration](./backups/backups/ha-backups.md) to learn how to backup your Rancher Server in case of a disaster scenario.
