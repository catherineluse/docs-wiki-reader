...
2. Use `helm repo add` command to add the Helm chart repository that contains charts to install Rancher. For more information about the repository choices and which is best for your use case, see [Choosing a Version of Rancher](./installation/resources/choosing-version.md).
  {{< release-channel >}}
    ```
...
> Want additional options? See the Rancher [Helm chart options](./installation/install-rancher-on-k8s/chart-options).
...
Then refer to [Adding TLS Secrets](./installation/resources/tls-secrets.md) to publish the certificate files so Rancher and the ingress controller can use them.
...
If you are installing Rancher versions before v2.3.0, you will not be able to use the packaged system charts. Since the Rancher system charts are hosted in Github, an air gapped installation will not be able to access these charts. Therefore, you must [configure the Rancher system charts](./installation/options/local-system-charts.md).

### Additional Resources

These resources could be helpful when installing Rancher:

- [Rancher Helm chart options](./installation/options/chart-options.md)
- [Adding TLS secrets](./installation/resources/tls-secrets.md)
...
- For Rancher before v2.3.0, you will need to mirror the `system-charts` repository to a location in your network that Rancher can reach. Then, after Rancher is installed, you will need to configure Rancher to use that repository. For details, refer to the documentation on [setting up the system charts for Rancher before v2.3.0.](./installation/options/local-system-charts.md)
...
| `<RANCHER_VERSION_TAG>`          | The release tag of the [Rancher version](./installation/options/server-tags.md) that you want to install. |
