...
Since a Kubernetes Installation requires a Kubernetes cluster, we will create a Kubernetes cluster using [Rancher Kubernetes Engine](./rke/latest/en.md) (RKE). Before being able to start your Kubernetes cluster, you'll need to [install RKE](./rke/latest/en/installation.md) and create a RKE config file.
...
### [Next: Install Rancher](./installation/other-installation-methods/air-gap/install-rancher)
