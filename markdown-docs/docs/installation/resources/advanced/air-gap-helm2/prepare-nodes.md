...
Make sure that your node(s) fulfill the general [installation requirements.](./installation/requirements.md)
...
If you need help with creating a private registry, please refer to the [Docker documentation](https://docs.docker.com/registry.md).
...
View hardware and software requirements for each of your cluster nodes in [Requirements](./installation/requirements).
