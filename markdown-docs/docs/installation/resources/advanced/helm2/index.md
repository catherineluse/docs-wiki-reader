...
> **Important:** For the best performance, we recommend a dedicated Kubernetes cluster for the Rancher management server. Running user workloads on this cluster is not advised. After deploying Rancher, you can [create or import clusters](./cluster-provisioning.md) for running your workloads.
...
- [rke](./rke/latest/en/installation.md) - Rancher Kubernetes Engine, cli for building Kubernetes clusters.
...
- [Create Nodes and Load Balancer](./installation/options/helm2/create-nodes-lb.md)
- [Install Kubernetes with RKE](./installation/options/helm2/kubernetes-rke.md)
- [Initialize Helm (tiller)](./installation/options/helm2/helm-init.md)
- [Install Rancher](./installation/options/helm2/helm-rancher.md)

## Additional Install Options

- [Migrating from a Kubernetes Install with an RKE Add-on](./upgrades/upgrades/migrating-from-rke-add-on.md)

## Previous Methods

[RKE add-on install](./installation/options/helm2/rke-add-on.md)
