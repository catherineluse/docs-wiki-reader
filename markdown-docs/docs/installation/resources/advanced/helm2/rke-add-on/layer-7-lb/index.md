...
- [NGINX Ingress controller (HTTP)](https://kubernetes.github.io/ingress-nginx.md)
...
* [Amazon ALB configuration](alb.md)
...
- **Recommended:** Review [Creating Backups—High Availability Back Up and Restore](./backups/backups/ha-backups.md) to learn how to backup your Rancher Server in case of a disaster scenario.
- Create a Kubernetes cluster: [Creating a Cluster](./tasks/clusters/creating-a-cluster.md).
