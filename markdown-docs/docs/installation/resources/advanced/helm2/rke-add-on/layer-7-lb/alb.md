...
>
>Please use the Rancher helm chart to install Kubernetes Rancher. For details, see the [Kubernetes Install ](./installation/options/helm2.md).
>
...
Log into the [Amazon AWS Console](https://console.aws.amazon.com/ec2.md) to get started.
