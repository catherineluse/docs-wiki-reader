...
>**Note:** For systems without direct internet access see [Air Gap: Kubernetes install](./installation/air-gap-high-availability.md) for install details.
...
See the [Troubleshooting](./installation/options/helm2/kubernetes-rke/troubleshooting.md) page.

### [Next: Initialize Helm (Install tiller)](./installation/options/helm2/helm-init.md)
