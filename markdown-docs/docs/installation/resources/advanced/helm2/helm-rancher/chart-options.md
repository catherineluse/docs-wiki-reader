...
> **Note:** If you are using a Private CA signed certificate, add `--set privateCA=true` and see [Adding TLS Secrets - Using a Private CA Signed Certificate](./installation/options/helm2/helm-rancher/tls-secrets.md) to add the CA cert for Rancher.
