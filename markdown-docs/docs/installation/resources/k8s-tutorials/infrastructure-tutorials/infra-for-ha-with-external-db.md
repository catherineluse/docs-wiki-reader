...
For more information about each installation option, refer to [this page.](./installation)
...
For a high-availability K3s installation, you will need to set a [MySQL](https://www.mysql.com.md) external database. Rancher has been tested on K3s Kubernetes clusters using MySQL version 5.7 as the datastore.
...
For an example of one way to set up the MySQL database, refer to this [tutorial](./installation/options/rds.md) for setting up MySQL on Amazon's RDS service.
