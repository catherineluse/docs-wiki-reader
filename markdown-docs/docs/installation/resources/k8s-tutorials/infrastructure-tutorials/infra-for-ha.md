...
For an example of one way to set up Linux nodes, refer to this [tutorial](./installation/options/ec2-node.md) for setting up nodes as instances in Amazon EC2.
