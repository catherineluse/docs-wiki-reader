...
1. Log into the [Amazon AWS RDS Console](https://console.aws.amazon.com/rds.md) to get started. Make sure to select the **Region** where your EC2 instances (Linux nodes) are created.
...
For more information on configuring the datastore for K3s, refer to the [K3s documentation.](./k3s/latest/en/installation/datastore.md)
