...
For systems without direct internet access, refer to [Air Gap: Kubernetes install.](./installation/air-gap-high-availability.md)
...
Also install [RKE,](./rke/latest/en/installation.md) the Rancher Kubernetes Engine, a Kubernetes distribution and command-line tool.
...
>
> Please see the [RKE Documentation](./rke/latest/en/config-options.md) for the full list of options and capabilities.
> 
> For tuning your etcd cluster for larger Rancher installations, see the [etcd settings guide](./installation/options/etcd.md).
...
- `rancher-cluster.rkestate`: The [Kubernetes Cluster State file](./rke/latest/en/installation/#kubernetes-cluster-state), this file contains credentials for full access to the cluster.<br/><br/>_The Kubernetes Cluster State file is only created when using RKE v0.2.0 or higher._
...
### [Next: Install Rancher](./installation/k8s-install/helm-rancher.md)
