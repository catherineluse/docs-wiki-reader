...
Follow the steps on [this page](./rancher/v2.x/en/installation/resources/update-ca-cert) to update the SSL certificate of the ingress in a Rancher [high availability Kubernetes installation](./installation/install-rancher-on-k8s.md) or to switch from the default self-signed certificate to a custom certificate.