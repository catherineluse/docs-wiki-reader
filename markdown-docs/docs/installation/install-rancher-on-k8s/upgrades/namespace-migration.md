...
> **Note:** If you are upgrading from from Rancher v2.0.13 or earlier, or v2.1.8 or earlier, and your cluster's certificates have expired, you will need to perform [additional steps](./cluster-admin/certificate-rotation/#rotating-expired-certificates-after-upgrading-older-rancher-versions) to rotate the certificates.
...
>**Prerequisites:**
>
>Download and setup [kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl.md).
...
- Using the cluster's [embedded kubectl shell](./k8s-in-rancher/kubectl.md).
- By [downloading the cluster kubeconfig file and running it](./cluster-admin/cluster-access/kubectl) from your workstation.
