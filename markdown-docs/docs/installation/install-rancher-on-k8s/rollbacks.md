...
For information on how to roll back Rancher installed with Docker, refer to [this page.](./installation/other-installation-methods/single-node-docker/single-node-rollbacks)
...
3. Rollback Rancher following the [normal instructions](./upgrades/rollbacks.md).
