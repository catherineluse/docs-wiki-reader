...
There are two types of catalogs in Rancher: [Built-in global catalogs](./catalog/built-in.md) and [custom catalogs.](./catalog/adding-catalogs.md)
...
* [Multi-cluster applications](./catalog/multi-cluster-apps.md)
...
For more information on how to use this feature, see [Global DNS](./helm-charts/globaldns.md).
