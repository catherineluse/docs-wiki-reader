...
You're ready to create your first Kubernetes [workload](https://kubernetes.io/docs/concepts/workloads.md). A workload is an object that includes pods along with other files and info needed to deploy your application.
...
- [Amazon AWS: Destroying the Environment](./quick-start-guide/deployment/amazon-aws-qs/#destroying-the-environment)
- [DigitalOcean: Destroying the Environment](./quick-start-guide/deployment/digital-ocean-qs/#destroying-the-environment)
- [Vagrant: Destroying the Environment](./quick-start-guide/deployment/quickstart-vagrant/#destroying-the-environment)
