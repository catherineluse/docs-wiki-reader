...
- [Microsoft Azure Account](https://azure.microsoft.com/en-us/free.md): A Microsoft Azure Account is required to create resources for deploying Rancher and Kubernetes.
