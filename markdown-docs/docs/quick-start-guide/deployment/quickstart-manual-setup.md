...
- A bare-metal server
  ...
  >
  > For a full list of port requirements, refer to [Docker Installation](./cluster-provisioning/node-requirements.md).

  Provision the host according to our [Requirements](./installation/requirements.md).
...
Use Rancher to create a deployment. For more information, see [Creating Deployments](./quick-start-guide/workload).
