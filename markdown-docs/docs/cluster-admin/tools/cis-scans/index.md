...
To run security scans on a cluster and access the generated reports, you must be an [Administrator](./admin-settings/rbac/global-permissions.md) or [Cluster Owner.](./admin-settings/rbac/cluster-project-roles.md)
...
> **Prerequisite:** You need to configure a [notifier](./cluster-admin/tools/notifiers.md) before configuring, sending, or receiving alerts.
...
1. Choose a [notifier](./cluster-admin/tools/notifiers.md) for the alert.
...
For more information about alerts, refer to [this page.](./cluster-admin/tools/alerts.md)
