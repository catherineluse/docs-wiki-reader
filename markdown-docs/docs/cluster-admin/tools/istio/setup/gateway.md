...
For more information on the Istio gateway, refer to the [Istio documentation.](https://istio.io/docs/reference/config/networking/v1alpha3/gateway.md) 
...
1. Under **Enable Ingress Gateway,** click **True.** The default type of service for the Istio gateway is NodePort. You can also configure it as a [load balancer.](./k8s-in-rancher/load-balancers-and-ingress/load-balancers.md)
...
### [Next: Set up Istio's Components for Traffic Management](./cluster-admin/tools/istio/setup/set-up-traffic-management)
