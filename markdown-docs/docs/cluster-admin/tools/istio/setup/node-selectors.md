...
> **Prerequisite:** Your cluster needs a worker node that can designated for Istio. The worker node should meet the [resource requirements.](./cluster-admin/tools/istio/resources)
...
### [Next: Add Deployments and Services](./cluster-admin/tools/istio/setup/deploy-workloads)