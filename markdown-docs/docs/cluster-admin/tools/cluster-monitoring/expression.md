...
The PromQL expressions in this doc can be used to configure [alerts.](./cluster-admin/tools/alerts.md)

> Before expressions can be used in alerts, monitoring must be enabled. For more information, refer to the documentation on enabling monitoring [at the cluster level](./monitoring-alerting/legacy/monitoring/cluster-monitoring.md) or [at the project level.](./project-admin/tools/monitoring.md)

For more information about querying Prometheus, refer to the official [Prometheus documentation.](https://prometheus.io/docs/prometheus/latest/querying/basics.md)
