...
Notifiers and alerts are built on top of the [Prometheus Alertmanager](https://prometheus.io/docs/alerting/alertmanager.md). Leveraging these tools, Rancher can notify [cluster owners](./admin-settings/rbac/cluster-project-roles/#cluster-roles) and [project owners](./admin-settings/rbac/cluster-project-roles/#project-roles) of events they need to address.

Before you can receive alerts, you must configure one or more notifier in Rancher.

When you create a cluster, some alert rules are predefined. You can receive these alerts if you configure a [notifier](./cluster-admin/tools/notifiers) for them.
...
When you edit an alert rule, you will have the opportunity to configure the alert to be triggered based on a Prometheus expression. For examples of expressions, refer to [this page.](./monitoring-alerting/v2.0.x-v2.4.x/cluster-monitoring/expression.md)

Monitoring must be [enabled](./monitoring-alerting/v2.0.x-v2.4.x/cluster-monitoring.md) before you can trigger alerts with custom Prometheus queries or expressions.
...
The scope for alerts can be set at either the cluster level or [project level](./project-admin/tools/alerts.md).
...
As a [cluster owner](./admin-settings/rbac/cluster-project-roles/#cluster-roles), you can configure Rancher to send you alerts for cluster events.

>**Prerequisite:** Before you can receive cluster alerts, you must [add a notifier](./monitoring-alerting/legacy/notifiers.md).
...
1. Finally, choose the [notifiers](./cluster-admin/tools/notifiers.md) to send the alerts to.
...
- [DaemonSet](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset.md)
- [Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment.md)
- [Node](https://kubernetes.io/docs/concepts/architecture/nodes.md)
- [Pod](https://kubernetes.io/docs/concepts/workloads/pods/pod.md)
- [StatefulSet](https://kubernetes.io/docs/concepts/workloads/controllers/statefulset.md)
...
This alert type monitors for events that occur on any node on marked with a label. For more information, see the Kubernetes documentation for [Labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels.md).
...
- [**ETCD**](https://etcd.io/docs/v3.4.0/op-guide/monitoring.md)
...
- [**Fluentd**](https://docs.fluentd.org/v1.0/articles/monitoring-prometheus) (supported by [Logging](./rancher/v2.0-v2.4//en/cluster-admin/tools/logging))
- [**Cluster Level Grafana**](http://docs.grafana.org/administration/metrics.md)
