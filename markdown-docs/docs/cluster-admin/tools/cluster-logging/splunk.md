...
If your organization uses [Splunk](https://www.splunk.com.md), you can configure Rancher to send it Kubernetes logs. Afterwards, you can log into your Splunk server to view logs.
