...
If your organization uses [Fluentd](https://www.fluentd.org.md), you can configure Rancher to send it Kubernetes logs.  Afterwards, you can log into your Fluentd server to view logs.
