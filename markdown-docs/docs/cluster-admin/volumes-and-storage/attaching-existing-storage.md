...
- To create a persistent volume as a Kubernetes resource, you must have the `Manage Volumes` [role.](./admin-settings/rbac/cluster-project-roles/#project-role-reference)
