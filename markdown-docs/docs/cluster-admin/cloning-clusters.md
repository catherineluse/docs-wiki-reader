...
|----------------------------------|---------------|
| [Nodes Hosted by Infrastructure Provider](./cluster-provisioning/rke-clusters/node-pools.md) | ✓ |
| [Hosted Kubernetes Providers](./cluster-provisioning/hosted-kubernetes-clusters.md) | ✓    |
| [Custom Cluster](./cluster-provisioning/rke-clusters/custom-nodes)              | ✓              |
| [Imported Cluster](./cluster-provisioning/imported-clusters.md)            |               |
...
Download and install [Rancher CLI](./cli). Remember to [create an API bearer token](./user-settings/api-keys) if necessary.
