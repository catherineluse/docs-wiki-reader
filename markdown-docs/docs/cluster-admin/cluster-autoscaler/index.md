...
In this section, you'll learn how to install and use the [Kubernetes cluster-autoscaler](https://github.com/kubernetes/autoscaler/blob/master/cluster-autoscaler.md) on Rancher custom clusters using AWS EC2 Auto Scaling Groups.
...
For details on running the cluster autoscaler  on Amazon cloud provider, refer to [this page.](./cluster-admin/cluster-autoscaler/amazon)
